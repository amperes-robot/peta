...
{\huge \bfseries ""}\\[0.4cm] % Thesis title
...
\emph{Instructors:} \\
{Dr. Andre Marziali \newline Dr. Jon Nakane \newline Mr. Bernhard Zender} % Instructors names
\end{flushright}
\end{minipage}\\[3cm]
...
\section{Electrical Design}
	...
	\begin{table}
		...
		\centering
		\begin{tabular}[t]{|p{.5in}|p{1.5in}|}
			\hline
			Digital Pin & Input/Output \\
			\hline
			0 & QRD pet marker tape detection \\
			\hline
