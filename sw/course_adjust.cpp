...
namespace course
{
	namespace
	{
		...
		enum { ZERO_TURN_THETA = 27, ZERO_BACK_THETA = -45, ZERO_FWD_THETA = 70, ZERO_TURN2_THETA = 20,
			ONE_TURN_THETA = 7, ONE_FWD_THETA = 15, TWO_TURN_THETA = 10, TWO_BACKUP_THETA = 5 };
