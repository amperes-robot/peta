...
namespace menu
{
	...
	Opt flw_thresh_left(TO_FSTR(strings::flw_thresh_left), 431);
	Opt flw_thresh_right(TO_FSTR(strings::flw_thresh_right), 250);
	Opt flw_thresh_side(TO_FSTR(strings::flw_thresh_side), 313);
